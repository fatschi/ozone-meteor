 ...
 * @author Arvid Heise
 */
public class GenericTestRecordsTest {
	private GenericTestRecords<PactRecord> records;

	private static TypeConfig<PactRecord> IntString = TestRecords.getPactRecordConfig(PactInteger.class, PactString.class);
	...
	@Before
	public void setup() {
		this.records = new GenericTestRecords<PactRecord>(IntString);
	}
